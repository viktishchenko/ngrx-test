...
// clone repo
Ctrl + Shift + p => clone git@github.com:DeborahK/angular-rxjs-signals-fundamentals.git

//  add branch
git br -M rxjs-signals-deborahk
...
// push remote branch
git push --set-upstream origin rxjs-signals-deborahk
